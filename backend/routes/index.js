...
router.get('/comments/:eventId', userController.getComments); // events with comments

router.post('/comments/', authenticateToken, userController.createComment); // testing
